package com.jspider.smswithspringmvcnew.controller;
...
import com.jspider.smswithspringmvcnew.service.AdminService;
...
public class AdminController {
	...
	public String getPageToAddAdmin(ModelMap modelMap) {
		 java.util.List<AdminPOJO> admins = adminService.getAllAdmins();
		if (admins.size() < 3) {
			return "add_admin";
		} else {
